...
const IMAGE_RULE = {
  deserialize(el, next, ignoreSpace) {
    if (el.tagName && el.tagName.toLowerCase() === 'img') {
      return {
        '$class': "".concat(NS_PREFIX_CommonMarkModel, "Image"),
        nodes: next(el.childNodes, ignoreSpace),
  ...
  deserialize(el, next, ignoreSpace) {
    ...
    if (tagName && tagName.toLowerCase() === 'span' && el.getAttribute('class') === 'variable') {
      ...
      if (el.getAttribute('format')) {
        variable = {
          '$class': "".concat(NS_PREFIX_CiceroMarkModel, "FormattedVariable"),
          name: el.getAttribute('name'),
        ...
        variable = {
          '$class': "".concat(NS_PREFIX_CiceroMarkModel, "EnumVariable"),
          name: el.getAttribute('name'),
          value: el.textContent,
...
const CONDITIONAL_RULE = {
  deserialize(el, next, ignoreSpace) {
    ...
    if (tagName && tagName.toLowerCase() === 'span' && el.getAttribute('class') === 'conditional') {
      ...
      return {
        '$class': "".concat(NS_PREFIX_CiceroMarkModel, "Conditional"),
        name: el.getAttribute('name'),
...
const OPTIONAL_RULE = {
  deserialize(el, next, ignoreSpace) {
    ...
    if (tagName && tagName.toLowerCase() === 'span' && el.getAttribute('class') === 'optional') {
      ...
      return {
        '$class': "".concat(NS_PREFIX_CiceroMarkModel, "Optional"),
        name: el.getAttribute('name'),
...
const FORMULA_RULE = {
  deserialize(el, next, ignoreSpace) {
    ...
    if (tagName && tagName.toLowerCase() === 'span' && el.getAttribute('class') === 'formula') {
      const formula = {
        '$class': "".concat(NS_PREFIX_CiceroMarkModel, "Formula"),
        name: el.getAttribute('name'),
        value: el.textContent
      };
...
const rules = [LIST_RULE, PARAGRAPH_RULE, STRONG_RULE, EMPH_RULE, LINK_RULE, HEADING_RULE, THEMATIC_BREAK_RULE, CODE_BLOCK_RULE, INLINE_CODE_RULE, BLOCK_QUOTE_RULE, CLAUSE_RULE, VARIABLE_RULE, CONDITIONAL_RULE, OPTIONAL_RULE, FORMULA_RULE, TEXT_RULE, HTML_INLINE_RULE, HTML_BLOCK_RULE, IMAGE_RULE];
